const x = globalThis, k = x.ShadowRoot && (x.ShadyCSS === void 0 || x.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, j = /* @__PURE__ */ Symbol(), B = /* @__PURE__ */ new WeakMap();
let Y = class {
  constructor(t, e, s) {
...
const rt = (r) => new Y(typeof r == "string" ? r : r + "", void 0, j), Mt = (r, ...t) => {
...
const { is: ot, defineProperty: ht, getOwnPropertyDescriptor: at, getOwnPropertyNames: lt, getOwnPropertySymbols: ct, getPrototypeOf: dt } = Object, T = globalThis, V = T.trustedTypes, pt = V ? V.emptyScript : "", ut = T.reactiveElementPolyfillSupport, b = (r, t) => r, M = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? pt : null;
      break;
...
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[b("elementProperties")] = /* @__PURE__ */ new Map(), y[b("finalized")] = /* @__PURE__ */ new Map(), ut?.({ ReactiveElement: y }), (T.reactiveElementVersions ??= []).push("2.1.2");
const z = globalThis, Z = (r) => r, H = z.trustedTypes, J = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, tt = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, et = "?" + f, $t = `<${et}>`, m = document, S = () => m.createComment(""), w = (r) => r === null || typeof r != "object" && typeof r != "function", L = Array.isArray, ft = (r) => L(r) || typeof r?.[Symbol.iterator] == "function", R = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K = /-->/g, F = />/g, _ = RegExp(`>|${R}(?:([^\\s"'>=/]+)(${R}*=${R}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), G = /'/g, Q = /"/g, st = /^(?:script|style|textarea|title)$/i, _t = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Tt = _t(1), g = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), X = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function it(r, t) {
...
const At = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === E ? p[1] === "!--" ? o = K : p[1] !== void 0 ? o = F : p[2] !== void 0 ? (st.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = _) : p[3] !== void 0 && (o = _) : o === _ ? p[0] === ">" ? (o = i ?? E, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? _ : p[3] === '"' ? Q : G) : o === Q || o === G ? o = _ : o === K || o === F ? o = E : (o = _, i = void 0);
    const $ = o === _ && r[a + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + $t : l >= 0 ? (s.push(c), h.slice(0, l) + tt + h.slice(l) + f + $) : h + f + (l === -2 ? a : $);
  }
    ...
    for (; (i = A.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(tt)) {
          ...
          h.push({ type: 1, index: n, name: U[2], strings: $, ctor: U[1] === "." ? yt : U[1] === "?" ? gt : U[1] === "@" ? vt : N }), i.removeAttribute(l);
        ...
        if (st.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let $ = 0; $ < u; $++) i.append(l[$], S()), A.nextNode(), h.push({ type: 2, index: ++n });
            i.append(l[u], S());
          }
        }
...
class P {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), w(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== g && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ft(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
bt?.(C, P), (z.litHtmlVersions ??= []).push("3.3.2");
const St = (r, t, e) => {
...
const wt = I.litElementPolyfillSupport;
wt?.({ LitElement: O });
